...
describe('WeeklyMetricsCard', () => {
  ...
  it('should render header and subheader', () => {
    ...
    expect(screen.getByText('Poise')).toBeTruthy();
    expect(screen.getByText('How you said it')).toBeTruthy();
  });
  ...
  it('should render metric label, value and unit', () => {
    ...
    expect(screen.getByText('Talk Time Average')).toBeTruthy();
  ...
  describe('Pillar Score Display', () => {
    ...
    it('should not render pillar score for null value', () => {
      ...
      expect(screen.getByText('How you collaborate')).toBeTruthy();
    });
    ...
    it('should not render pillar score for undefined value', () => {
      ...
      expect(screen.getByText('Your awareness')).toBeTruthy();
    });
  });
});
