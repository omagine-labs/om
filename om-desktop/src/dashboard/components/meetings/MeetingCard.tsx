...
export default function MeetingCard({
  ...
  const handleSaveTitle = async () => {
    ...
    try {
      const result = await meetingsApi.updateMeetingTitle(
        meeting.id,
        trimmedTitle
      );
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="ml-4 flex items-center gap-3">
          ...
          {/* Status chip - shown for pending/processing/failed states, or completed but waiting for speaker data */}
          {!isUploading &&
          ...
          {/* Action button - View Analysis or Identify Yourself */}
          {!isUploading &&
