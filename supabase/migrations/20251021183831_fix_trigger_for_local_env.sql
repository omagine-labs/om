-- Fix trigger to work in local development environment
-- This migration updates the trigger to call local Supabase Edge Functions
-- For production, this migration should NOT be applied (or should be reverted)
...
BEGIN
  ...
  IF NEW.status = 'pending' THEN
    ...
    -- and needs to reach the host machine where Supabase Edge Functions are running
