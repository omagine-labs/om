-- Migration: Update weekly rollup function to include agentic scores
-- Description: Adds avg_clarity_score, avg_confidence_score, avg_collaboration_score,
--              and avg_attunement_score to the calculate_user_weekly_rollup function

BEGIN;

-- ============================================================================
-- Update calculate_user_weekly_rollup function to include agentic scores
-- ============================================================================
...
BEGIN
  ...
  -- Insert or update the rollup with all metrics including agentic scores
...
COMMENT ON FUNCTION public.calculate_user_weekly_rollup IS 'Calculates weekly performance rollup for a user, including agentic communication scores';
